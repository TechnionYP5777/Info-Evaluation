 ...
 * 
 * @author netanel
 * This class represents a tuple in the final table
 * that is shown to the user in the GUI
 *
 */
class tableTuple{
	...
	// we save in date format in order to be able to do manipulations on the DB according to the date
